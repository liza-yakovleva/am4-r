...
class GameItem extends Component {
  ...
  render() {
    ...
    return ( <
      ...
      className = "gam-game-img"
      alt = "img" / >
      <
      div className = "gam-game-cont-box" >

      <
      div className = "gam-game-rating" > {
        reiting
      } < /div> <
      div className = "gam-game-name" > {
        name
      } < /div> <
      div className = "gam-descrip-name" > {
        description
      } < span className = "gam-descrip-name-green" > {
        s_description
      } < /span></div >
      <
      div className = "gam-game-text" > {
        text
      } < /div> <
      div className = "gam-game-ico-box" >
      <
      div className = "gam-game-num" > {
        share
      } < /div> <
